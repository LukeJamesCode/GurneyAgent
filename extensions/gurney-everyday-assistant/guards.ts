// Post-turn reply guards for this extension's domains. These catch the two
// hallucinations a small (0.8b/2b) chat model produces against everyday-assistant
// tools, and live here — not in core — because a host without this extension has
...
import type { Host, TurnGuard, TurnGuardInput } from '../../src/core/extensions.js';
