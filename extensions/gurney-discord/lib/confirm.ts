...
import type { ChatConfirmRequest } from '../../../src/core/extensions.js';
...
export interface ConfirmTransport {
  // Resolve the (channelId, isDm) for a synthetic Gurney chatId. Used to
...
function newToken(): string {
  ...
  // the pending-set size we'll ever see in a single Gurney process.
